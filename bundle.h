...
public:
	bool SignFolder(ZSignAsset *pSignAsset, const string &strFolder, const string &strBundleID, const string &strDisplayName, const string &strMinimumOSVersion, const string &strDyLibFile, bool bForce, bool bWeakInject, bool bEnableCache);
